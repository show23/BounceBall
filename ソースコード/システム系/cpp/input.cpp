...
static XINPUT_STATE Xinput_Gpad[GAMEPADMAX];
//--------------------------------- game pad
...
void UpdatePad(void)
{
	...
	for (i = 0; i < padCount; i++)
	{
		...
		//コントローラーのスティック情報を抜くところ
		stickL_X = dijs.lX;
		stickL_Y = dijs.lY;


		stickR_X = dijs.lZ  - (65535 / 2);
		stickR_Y = dijs.lRz - (65535 / 2);
