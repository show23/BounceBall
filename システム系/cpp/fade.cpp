...
{
	//テクスチャ生成
	fadeTex = LoadTexture("data/TEXTURE/Back.png");
...
void DrawFade(void)
{
	...
	DrawSpriteColor(fadeTex, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, SCREEN_WIDTH, SCREEN_HEIGHT, 0.0f, 0.0f, 1.0f, 1.0f, g_Color);
}
...
void SetOldScene() {
	if(g_SceneNext != SCENE_GAMEOVER_cont && g_SceneNext != SCENE_CLEAR_cont){
	g_SceneOld = g_SceneNext;
	}
}
